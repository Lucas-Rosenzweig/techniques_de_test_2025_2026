...
def find_bad_triangles(point: Point, triangulation: list["Triangle"]) -> list["Triangle"]:
...
def is_edge_shared(edge: tuple[Point, Point], current_triangle: "Triangle",bad_triangles: list["Triangle"]) -> bool:
...
def remove_super_triangle_vertices(triangles: list[Triangle], super_triangle: Triangle) -> list[Triangle]:
